...
- **CSS Modules + webpack**: `*.module.css`, `import styles from "./X.module.css"`; css-loader v7 requires `modules.namedExport: false` in webpack (see `rules/architecture.mdc`, `skills/architecture/references/react-node-structure.md`).
